...
const Banner = () => {
  return (
    <section className="bg-white bg-no-repeat md:bg-right bg-center md:bg-contain bg-cover dark:bg-black w-full h-[90vh] flex flex-row" style={{backgroundImage: "url('/banner-image.png')"}}>
      ...
      <div>
        <Image src={'/banner-detail.png'} width={1000} height={1000} alt="vector" className="absolute h-[90vh] top-[10vh] w-[60vw] z-0 hidden md:dark:block" />
        <Image src={'/banner-detail-light.png'} width={1000} height={1000} alt="vector" className="absolute h-[90vh] top-[10vh] w-[60vw] z-0 hidden md:block dark:hidden" />
      ...
      <div className="md:w-2/4 w-full h-full pt-2 flex md:justify-start items-center gap-4 flex-col z-10">
        ...
        <button className="p-2 rounded bg-red-700 text-white">
          <a href="https://wa.me/5555319078278?text=Ol%C3%A1%2C+eu+quero+pizza%21" target="_blank">Pedir agora</a>
        </button>
      </div>
